...
function initSearch() {
  ...
  request.open('GET', '/NEDSS-SystemAdminGuide/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/NEDSS-SystemAdminGuide/assets/css/just-the-docs-' + theme + '.css');
}
